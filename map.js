    ...
    map.addLayer(
        {
          ...
          source: {
            type: "geojson",
            data: "data/citiGeoStarts2009.geojson",
          },
          minzoom: 6,
...
map2.on("load", function () {
    ...
    map2.addLayer(
      {
        ...
        source: {
          type: "geojson",
          data: "data/citiGeoStarts2109.geojson",
        },
        minzoom: 6,
        paint: {
          "circle-radius": 3,
 ...
 // Create the popup
 map2.on('click', 'citiGeoStarts21', function (e) {
...
// Change the cursor to a pointer when the mouse is over the us_states_elections layer.
map2.on('mouseenter', 'citiGeoStarts21', function () {
  map2.getCanvas().style.cursor = 'pointer';
});
// Change it back to a pointer when it leaves.
map2.on('mouseleave', 'citiGeoStarts21', function () {
